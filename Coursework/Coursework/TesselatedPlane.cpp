//Jamie Haddow TesselatedPlane.cpp
//COMMENTING DONE

#include "TesselatedPlane.h"

//resolution used for the size of the plane(how many A x B there is)
TesselatedPlane::TesselatedPlane(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int _resolution)
{
...
void TesselatedPlane::initBuffers(ID3D11Device* device)
{
